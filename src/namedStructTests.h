...
namespace namedStructTests {
    ...
    typedef struct __attribute__((packed)) testStruct23 {
        ...
        /** Returns void-pointer to member noString.
         *  If noString is null/void then the result is undefined. */
        inline void* getNoString() const {
            return (void*)(uintptr_t(this)+this->noStringByteOffset);
        }
    } testStruct23;
    ...
    typedef struct __attribute__((packed)) testStruct37 {
        ...
        /** Returns void-pointer to member stringRef.
         *  If stringRef is null/void then the result is undefined. */
        inline void* getStringRef() const {
            return (void*)(uintptr_t(this)+this->stringRefByteOffset);
        }
        
        /** Returns void-pointer to member bitFieldReference.
         *  If bitFieldReference is null/void then the result is undefined. */
        inline void* getBitFieldReference() const {
            return (void*)(uintptr_t(this)+this->bitFieldReferenceByteOffset);
        }
        
        /** Returns void-pointer to member int8ArrayRef.
         *  If int8ArrayRef is null/void then the result is undefined. */
        inline void* getInt8ArrayRef() const {
            return (void*)(uintptr_t(this)+this->int8ArrayRefByteOffset);
        }
        
        /** Returns void-pointer to member uint8Ref.
         *  If uint8Ref is null/void then the result is undefined. */
        inline void* getUint8Ref() const {
            return (void*)(uintptr_t(this)+this->uint8RefByteOffset);
        }
    } testStruct37;
    ...
    enum class NationEnum : char {
        ...
        typedef struct __attribute__((packed)) bitField43 {
            ...
            inline void setS1(int v) {
                ...
                uint16_t bitValue = (intValue << 1)^(intValue>>15);
        ...
        typedef struct __attribute__((packed)) BitField44 {
            ...
            inline void setField(int v) {
                ...
                uint32_t bitValue = (intValue << 1)^(intValue>>31);
